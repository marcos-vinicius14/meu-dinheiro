...
class RefreshTokenHashTest {
    ...
    void sameInputProducesSameHash() {
        assertThat(RefreshTokenHash.sha256("token"))
                .isEqualTo(RefreshTokenHash.sha256("token"));
    }

    @Test
    void differentInputsProduceDifferentHashes() {
        assertThat(RefreshTokenHash.sha256("token-1"))
                .isNotEqualTo(RefreshTokenHash.sha256("token-2"));
    }
}
