...
class CategoryModelTest {
  ...
  void createCategoryWithNullIconStoresNullIcon() {
    var category =
        CategoryModel.create(
            CategoryDescription.create("Transporte").value(), null, false, createUser());
  ...
  void belongsToReturnsTrueForSameUser() {
    var user = createUser();
    var category =
        CategoryModel.create(CategoryDescription.create("Lazer").value(), null, false, user);
  ...
  void belongsToReturnsFalseForDifferentUser() {
    ...
    var category =
        CategoryModel.create(CategoryDescription.create("Lazer").value(), null, false, owner);
  ...
  void updateDescriptionChangesDescription() {
    var category =
        CategoryModel.create(
            CategoryDescription.create("Antiga").value(), null, false, createUser());
