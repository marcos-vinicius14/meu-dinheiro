...
public class CategoryModel {
  ...
  private CategoryModel(String description, String icon, boolean flexible, UserModel user) {
  ...
  public static CategoryModel create(
      CategoryDescription description, CategoryIcon icon, boolean flexible, UserModel user) {
    return new CategoryModel(
        description.value(), icon != null ? icon.value() : null, flexible, user);
  }
