...
public final class TransactionMessages {
    ...
    public static final String TRANSACTION_CATEGORY_INVALID_TYPE = "Categoria incompatível com o tipo da transação";
    public static final String TRANSACTION_BANK_ACCOUNT_NOT_FOUND = "Conta bancária não encontrada";
    public static final String TRANSACTION_TYPE_NOT_INSTALLMENT = "Transações parceladas devem ser criadas via bundle";
    public static final String BUNDLE_INSTALLMENTS_REQUIRED = "Número de parcelas deve ser positivo";
    public static final String BUNDLE_TOTAL_AMOUNT_REQUIRED = "Valor total do parcelamento deve ser positivo";
    public static final String BUNDLE_FIRST_DUE_DATE_REQUIRED = "Data do primeiro vencimento é obrigatória";
