...
public class CreateTransactionBundleUseCaseImpl implements CreateTransactionBundleUseCase {
    ...
    @Transactional
    @Override
    public OperationResult<TransactionBundleOutput> execute(UUID userId, CreateTransactionBundleInput input) {
        ...
        try {
            var bundle = TransactionBundleModel.create(
                    input.description(),
            ...
            return OperationResult.success(new TransactionBundleOutput(
                    persisted.getId(),
